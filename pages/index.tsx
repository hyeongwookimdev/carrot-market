    ...
    <div className="bg-slate-400 py-20 px-20 grid gap-10 xl:place-content-center lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <div className="flex justify-between mt-2 pt-2 border-t-2 border-dashed">
          <span>Total</span>
          <span className="font-semibold dark:text-white">$970</span>
        </div>

        <button
          className="mt-5 bg-blue-500 dark:bg-black dark:border-white dark:border  text-white p-3 text-center rounded-xl w-3/4 block mx-auto
      ...
      <div className="bg-white overflow-hidden  rounded-3xl shadow-xl group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          ...
          <div className="relative flex flex-col items-center -mt-10 -mb-5">
            <span className="text-lg font-medium">Hyeongwoo Kim</span>
